...
# wecode 한달차 회고록, 부제: 도미도 효과
# 🔴 2022년의 시작이 다사다난했다.
원래라면 새해의 시작인 1월부터 wecode와 함께할 예정이었지만, <u>뜻하지 않은 교통사고</u>로 깁스를 하게 되었고 그로인해 내가 생각해던 계획들을 수정해야했다. 그리고 시간이 생겼지만 집중하지 못한 시간이었다. 병원을 다녀야했고 발목부터 허벅지 안쪽까지 깁스를 하면서 책상에 앉는 것도 불편했기 때문이었다. `하지만 덕분에 지금의 소중한 30기 동기`들을 만날 수 있었다.  
<img src="https://user-images.githubusercontent.com/87808288/193294954-d1a905ea-aaca-41ee-9af1-51147dcc8eae.png" width="35%">

# 🔴 눈물의 wecode
wecode 에 들어오기 전에 코딩과 친해지려 파이썬을 처음으로 여러 프로그래밍 언어들을 학습했다. 그러다가 JavaScript 에 가장 흥미가 생겼고 사전학습을 진행했다. 그런데 HTML 와 CSS 가 기본인 것을 JavaScript 가 재밌다보니 다른 것을 하지 않고 wecode 에 들어왔다. 물론 정말 마음의 준비도 했다. 그런데 내가 사전 학습으로 공부한 것들이 단 며칠로 모두 거쳐나갔고 머리로는 감이 잡히는 것 같았지만, 막상 손으로 code를 치지 못했다.  
<img src="https://user-images.githubusercontent.com/87808288/193295930-a499e46d-8526-45eb-af58-5c5c8708248e.png" width="40%">
