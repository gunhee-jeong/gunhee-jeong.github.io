...
초기화문이 있는 변수 선언문은 자바스크립트 엔진에 의해 <span style="color:royalblue">var 키워드가 없는 것처럼 동작</span>하고  
...
하지만 const 키워드로 선언된 변수에 <span style="color:royalblue">객체를 할당한 경우</span> <span style="color:blue">값을 변경할 수 있다</span>.  
