...
`toUpperCase()` 메서드는 문자열을 <span style="color:crimson">대문자로 변환</span>해준다.  
...
`toLowerCase()` 메서드는 문자열을 <span style="color:crimson">소문자로 변환</span>해준다.  
...
## 2장 아스키 코드
<img src="https://user-images.githubusercontent.com/87808288/186287401-12c933a4-0a17-4280-ad3b-5c0c66c7d2a7.png" width="50%">

### 1. String.prototype.charCodeAt()
`charCodeAt()` 메서드는 주어진 인덱스에 대한 <span style="color:crimson">UTF-16 코드</span>를 나타내는 65535 사이의 <u>정수를 반환</u>한다.  
알파벳 등의 string을 <span style="color:tomato">아스키 코드의 정수로 반환</span>해준다.  

### 2. Stirng.prototype.formCharCode()
