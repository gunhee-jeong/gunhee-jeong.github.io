...
Ajax는 <u>브라우저에게 제공하는 Web API</u>인 <span style="color:blue">XMLHttpRequest 객체를 기반으로 동작</span>한다.  
...
`XMLHttpRequest 객체`는 XMLHttpRequest 생성자 함수를 호출하여 생성한다. XMLHttpRequest 객체는 <u>브라우저에게 제공하는 Web API</u>이므로 <span class="teal">브라우저 환경에서만 정상적으로 실행</span>된다.
...
<img src="https://user-images.githubusercontent.com/87808288/173275707-c615993f-62bc-4130-a8de-a75b1ff95fce.png" width="90%">  
<img src="https://user-images.githubusercontent.com/87808288/173275733-a3ae5150-8372-40a7-83c1-d9686e9a6524.png" width="90%">  

#### [XMLHttpRequest 객체의 이벤트 핸들러 프로퍼티]
<img src="https://user-images.githubusercontent.com/87808288/173275792-54f3cc5c-f490-43c2-bc6c-979a59c1025b.png" width="90%">  
XMLHttpRequest 객체에서 발생하는 이벤트들의 종류를 나타낸다.  

#### [XMLHttpRequest 객체의 메서드]
<img src="https://user-images.githubusercontent.com/87808288/173275892-836fac09-0e51-45f7-93d3-565d6983c3b0.png" width="90%">  

#### [XMLHttpRequest 객체의 정적 프로퍼티]
<img src="https://user-images.githubusercontent.com/87808288/173275951-100ff737-e620-4bb7-9d26-3a17efc35163.png" width="90%">  
<img src="https://user-images.githubusercontent.com/87808288/173275994-63f93271-b126-4a9b-9084-94c40f73f0f8.png" width="90%">  
...
open 메서드는 서버에 전송한 HTTP 요청을 초기화한다. open 메서드를 호출하는 방법은 다음과 같다.
...
send 메서드는 open 메서드로 초기화된 HTTP 요청을 서버에 전송한다. 기본적으로 전송하는 데이터는 GET, POST 요청 메서드에 따라 전송 방식에 차이가 있다.
