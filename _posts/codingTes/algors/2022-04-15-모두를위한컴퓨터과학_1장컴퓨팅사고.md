...
알고리즘을 평가할 때는 <span style="color:blue">정확성</span>도 중요하지만, <span style="color:red">효율성</span>도 중요하다.  
...
'정건희'라는 이름이 지금 페이지보다 앞에 있는지 뒤에 있는지 알 수 있을 것이다.  
...
단 한 번의 동작으로 200페이지의 절반인 100페이지가 사라지기 때문이다.  
### (3) 의사코드
