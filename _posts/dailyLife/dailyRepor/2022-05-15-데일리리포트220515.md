...
date: 2022-05-15T08:50:00+09:00
# sidebar:
# nav: "docs" #네비게이션에 있는 docs를 의미함
---
# 오전
1010 ~ : 모두의 네트워크 -> <span style="color:royalblue">집중도 중</span>

# 오후

# 결산
<!-- 어제의 `수면`: <span style="color:purple">6시간</span> -> <span style="color:blue">집중도 중</span>   -->
오늘의 `순 생산성 시간`: <span style="color:blue"> 시간 분</span>  
